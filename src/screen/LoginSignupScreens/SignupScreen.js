            ...
            {successmsg == null ?
                <View style={styles.container}>
                    ...
                    <View style={styles.inputout}>
                        <AntDesign name="user" size={24} color={namefocus === true ? '#63FFD1' : colors.text2} />
                    ...
                    <View style={styles.inputout}>
                        <Entypo name="email" size={24} color={emailfocus === true ? '#63FFD1' : colors.text2} />
                    ...
                    <View style={styles.inputout}>
                        <Feather name="smartphone" size={24} color={phonefocus === true ? '#63FFD1' : colors.text2} />
                    ...
                    {/* password start */}
                    <View style={styles.inputout}>
                        <MaterialCommunityIcons name="lock-outline" size={24} color={passwordfocus == true ? '#63FFD1' : colors.text2} />
                    ...
                    {/*  */}
                    <View style={styles.inputout}>
                        <MaterialCommunityIcons name="lock-outline" size={24} color={cpasswordfocus == true ? '#63FFD1' : colors.text2} />
                    ...
                    <TouchableOpacity style={btn1} onPress={() => handleSignup()}>
                        <Text style={{ color: '#63FFD1', fontSize: titles.btntxt, fontWeight: "bold" }}>Sign up</Text>
                    </TouchableOpacity>
